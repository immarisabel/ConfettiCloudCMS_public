package nl.marisabel.confetticloud.cms.security.utils;
...
public class SecurityConstants {
	 ...
	 */
	public static final String SECRET_KEY = "fVdQojN56LaT3poFp2MEilvzem9Jy4Eu9Pl28rE3B3M7HD4bB352xXg0hNrJdTdC";

	/**
	 * The company who provided token.
	 * You can customize issuer name, this is given as an example.
	 */
	public static final String ISSUER = "https://marisabel.nl";
	...
	public static final String LOGIN_REQUEST_URI = "/secret-passage/v1/login";

	public static final String REGISTRATION_REQUEST_URI = "/secret-passage/v1/register";
